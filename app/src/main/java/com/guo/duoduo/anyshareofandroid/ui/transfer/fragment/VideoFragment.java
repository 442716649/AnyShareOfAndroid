 ...
 */
public class VideoFragment extends Fragment implements VideoSelectAdapter.OnItemClickListener, OnSelectItemClickListener {
...
//            getList();
    ...
    private void getVideos() {
        ...
        queryHandler.startQuery(1, null, MediaStore.Video.Media.EXTERNAL_CONTENT_URI, new String[]{MediaStore.Video.Media.DATA, MediaStore.Video.Media._ID}, null, null, MediaStore.Video.Media.DATE_MODIFIED + " DESC");
...
//    }
    ...
    public void onItemClick(View view, int position) {
        ...
        fileInfo.type = P2PConstant.TYPE.VID;
        ...
        activity.onItemClicked(P2PConstant.TYPE.VID);
    }
...
//                    {
                    ...
                    if (file.exists()) {
                        ...
                        info.vidPath = str;
                        info.vidSize = DeviceUtils.getFileSize(file.length());
                        info.vidName = DeviceUtils.getFileName(str);
...
//                    }
    ...
    private static class PictureHandler extends Handler {
        ...
        public PictureHandler(VideoFragment fragment) {
