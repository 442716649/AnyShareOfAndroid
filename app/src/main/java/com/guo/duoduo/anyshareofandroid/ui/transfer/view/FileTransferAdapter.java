...
public class FileTransferAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.file_trans_speed = (TextView) convertView.findViewById(R.id.file_trans_speed);
            holder.trans_progress = (ProgressBar) convertView.findViewById(R.id.trans_progress);
        ...
        if (file != null) {
            ...
            } else if (file.type == P2PConstant.TYPE.AUD) {
                holder.file_image.setImageResource(R.mipmap.audio_icon);
            } else if (file.type == P2PConstant.TYPE.VID) {
                holder.file_image.setImageResource(R.mipmap.video_icon);
            }
            ...
            if (file.percent >= 100) {
                ...
                holder.file_trans_speed.setText(context.getString(R.string.file_has_completed));
                holder.file_trans_speed.setTextColor(context.getResources().getColor(R.color.blue));
            } else {
                holder.trans_progress.setVisibility(View.VISIBLE);
                if (file.percent == 0) {
                    holder.file_trans_speed.setText(context.getString(R.string.file_wait));
                    holder.file_trans_speed.setTextColor(context.getResources().getColor(R.color.green));
                }
            }
        }
